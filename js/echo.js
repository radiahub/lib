...
var echo = {
	...
	init : function()
	{
		if (! DOMExists("DIV_ECHO_CONTAINER")) {
			...
			//var filepath = context.libpath() + "html/echo.html";
			//alert(filepath);
			var html = file2bin(context.libpath() + "html/echo.html");
			//alert(strlen(html));
			if (strlen(html) > 0) {
...
// ****************************************************************************
/*
window.console.log   = function(st) { echo.log(st);   };
window.console.info  = function(st) { echo.info(st);  };
window.console.warn  = function(st) { echo.warn(st);  };
window.console.error = function(st) { echo.error(st); };
*/
